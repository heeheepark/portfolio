...
const Skills = () => {
  return (
    <div className="w-full h-full flex flex-col items-center">
      ...
      <div className="container w-full h-full m-auto px-24 flex flex-col gap-3">
        <div className="w-full h-full flex justify-start" data-aos="fade-right">
          ...
          <p className="speech-bubble-react text-base font-semibold">
        ...
        <div
          className="w-full h-full flex flex-row-reverse justify-start"
          data-aos="fade-left"
        >
          <img
          ...
          />
          <p className="speech-bubble-javascript text-base font-semibold">
        ...
        <div className="w-full h-full flex justify-start" data-aos="fade-right">
          ...
          />
          <p className="speech-bubble-typescript text-base font-semibold">
        ...
        >
          ...
          <p className="speech-bubble-html text-base font-semibold">
        ...
        <div className="w-full h-full" data-aos="fade-right">
          <div className="flex justify-start">
            ...
            <p className="speech-bubble-css text-base font-semibold">
        ...
        <div className="w-full h-full" data-aos="fade-right">
          <div className="flex flex-row-reverse justify-start">
            <img
              ...
              className="w-10 h-10 ml-5"
            />
            <p className="speech-bubble-swagger text-base font-semibold">
